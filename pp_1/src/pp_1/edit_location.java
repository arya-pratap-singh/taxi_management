 ...
 * @author u7yh7h
 */
public class edit_location extends javax.swing.JFrame {

    /**
     * Creates new form edit_location
     */
    public edit_location() {
       ...
       try{
        ...
        String sql = "select region from pickup";
        ResultSet rs = stmt.executeQuery(sql);
        while(rs.next()){
        dflm.addElement(rs.getString("region"));
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
        ...
        try{
            ...
            Statement stmt = con.createStatement();
            String reg = (String) jList1.getSelectedValue();
            String sql1 = "select * from pickup where region='"+(reg)+"';";
           ...
           try
            {
             ...
             String reg = (String) jList1.getSelectedValue();
             String query = "select * from pickup where region ='"+(reg)+"';";
             ...
             String Distance =jTextField4.getText();
                     ...
                     String cty =(String) rs.getString(3);
                     String rg =(String) rs.getString(4);
                     String dt = (String) rs.getString(5);
             ...
             jLabel11.setText("Cannot be empty");
             ...
             else if(st.equals(jTextField1.getText())&&cty.equals(jTextField2.getText())&&rg.equals(jTextField3.getText())&&dt.equals(jTextField4.getText())){
                 ...
                 if(ans==JOptionPane.YES_OPTION){
                     String q1 = "update pickup set state ='"+(state)+"',city ='"+(city)+"',region ='"+(Region)+"',distance ="+(Distance)+" where region ='"+(reg)+"';";
                     ...
                     //code refresh the list
                              DefaultListModel dflm = (DefaultListModel)jList1.getModel();
                               ...
                               String sql1 = "select region from pickup";
                               ...
                               jTextField4.setText("");
                               while(rs1.next()){
                               dflm.addElement(rs1.getString("region"));
    ...
    private void jLabel12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseClicked
        ...
        String reg = (String) jList1.getSelectedValue();
        int a = JOptionPane.showConfirmDialog(this,"do you want to delete location "+(reg)+"?");
        if(a == JOptionPane.YES_OPTION){
        try{
            Class.forName("java.sql.Driver");
        Connection con=DriverManager.getConnection("jdbc:mysql://localhost/taxi_booking","root","");
        Statement stmt = con.createStatement();
        String q ="delete from pickup where region = '"+(reg)+"';";
        jTextField1.setText("");
        jTextField2.setText("");
        jTextField3.setText("");
        jTextField4.setText("");
        ...
        String q1="Select region from pickup;";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(edit_location.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
